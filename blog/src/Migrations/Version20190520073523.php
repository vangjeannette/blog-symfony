 ...
 */
final class Version20190520073523 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tag DROP FOREIGN KEY FK_389B7831EBAF6CC');
        $this->addSql('DROP INDEX IDX_389B7831EBAF6CC ON tag');
        $this->addSql('ALTER TABLE tag DROP articles_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tag ADD articles_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE tag ADD CONSTRAINT FK_389B7831EBAF6CC FOREIGN KEY (articles_id) REFERENCES article (id)');
        $this->addSql('CREATE INDEX IDX_389B7831EBAF6CC ON tag (articles_id)');
    }
}
